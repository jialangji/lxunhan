...
public class OptionsPickerBuilder {
    ...
    //Required
    public OptionsPickerBuilder(Context context, OnOptionsSelectListener listener, int layoutType) {
        mPickerOptions = new PickerOptions(PickerOptions.TYPE_PICKER_OPTIONS,layoutType);
