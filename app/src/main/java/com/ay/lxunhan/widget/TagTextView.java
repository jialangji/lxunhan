...
public class TagTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public void setContentAndTag(int layout,String content, String tags,int color) {
        ...
        View view = LayoutInflater.from(mContext).inflate(layout, null);//R.layout.tag是每个标签的布局
        tv_tag = view.findViewById(R.id.tv_tag);
        tv_tag.setBackgroundColor(mContext.getResources().getColor(color));
        tv_tag.setText(tags);
