...
public class AZSideBarView extends View {
    ...
    private void initAttribute(AttributeSet attrs, int defStyleAttr) {
        ...
        mBackgroundColor = typeArray.getColor(R.styleable.AZSideBarView_backgroundColor, ResourceUtil.getColor(getContext(), R.color.transparent));
        mStrokeColor = typeArray.getColor(R.styleable.AZSideBarView_strokeColor, ResourceUtil.getColor(getContext(), R.color.transparent));
        mTextColor = typeArray.getColor(R.styleable.AZSideBarView_textColor, ResourceUtil.getColor(getContext(), R.color.color_303133));
        ...
        mSelectTextColor = typeArray.getColor(R.styleable.AZSideBarView_selectTextColor, ResourceUtil.getColor(getContext(), R.color.blue_text));
