package com.ay.lxunhan.widget.bg;
...
public class ParticleView extends View {
    ...
    public ParticleView(Context context, @Nullable AttributeSet attrs) {
        ...
        count = array.getInt(R.styleable.ParticleView_pv_count, 5);
        alpha = array.getInt(R.styleable.ParticleView_pv_alpha, 60);
        minSize = array.getInt(R.styleable.ParticleView_pv_min_size, 100);
        maxSize = array.getInt(R.styleable.ParticleView_pv_max_size, 150);
