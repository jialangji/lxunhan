 ...
 * @date 2020/8/5
 */
public class HomeTypeFragment extends BaseFragment<HomeContract.HomeView, HomePresenter> implements HomeContract.HomeView {
    ...
    public static HomeTypeFragment newInstance(String id) {
