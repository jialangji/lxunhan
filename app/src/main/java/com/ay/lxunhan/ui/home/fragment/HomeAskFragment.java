 ...
 * @date 2020/8/5
 */
public class HomeAskFragment extends BaseFragment<HomeContract.HomeView, HomePresenter> implements HomeContract.HomeView {
    ...
    public static HomeAskFragment newInstance() {
        Bundle args = new Bundle();
        HomeAskFragment fragment = new HomeAskFragment();
    ...
    protected void initView() {
        super.initView();
        homeAdapter = PublicAdapterUtil.getAdapter(homeList, getActivity(), false);
    ...
    protected int getLayoutId() {
        return R.layout.fragment_home_ask;
    }
