 ...
 * @date 2020/8/5
 */
public class HomeQuizFragment extends BaseFragment<HomeContract.HomeView, HomePresenter> implements HomeContract.HomeView {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_home_quiz;
    }
